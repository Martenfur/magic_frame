...
pal_image6 = Image.new("P", (1,1))
pal_image6.putpalette( (0,0,0,  255,255,255,  0,255,0,   0,0,255,  255,0,0, 255,128,0) + (0,0,0)*250)
...
img.convert("RGB").quantize(palette=pal_image6).show()
